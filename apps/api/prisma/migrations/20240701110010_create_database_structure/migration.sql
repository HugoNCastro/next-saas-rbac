...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_organiztion_id_fkey" FOREIGN KEY ("organiztion_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
